...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.message_bytes = 4
        self.is_loaded = False
        self.need_size = self.message_bytes + len(self.marker)
    ...
    def encodeMsg(self):
        ...
        self.image_size = (self.image.width() * self.image.height() * 3) // 8 - len(self.marker)-self.message_bytes
    ...
    def bit(image: QImage, index) -> bool:
    ...
    def decodeMsg(self):
        ...
        for i in range(index2 * 8,stop2):
            temp2 = (temp2 << 1) | bit(self.image, i)
